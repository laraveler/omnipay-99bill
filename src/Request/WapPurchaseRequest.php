...
use Omnipay\Bill99\Response\WapPurchaseResponse;
use Omnipay\Common\Exception\InvalidRequestException;

/**
 * Class WapPurchaseRequest
 * @package Omnipay\Bill99\Request
 * @author laraveler <happyjkw2005@gmail.com>
 */
class WapPurchaseRequest extends AbstractRequest
{
	protected $version = 'mobile1.0';
	protected $productionEndpoint = 'https://www.99bill.com/mobilegateway/recvMerchantInfoAction.htm';
	protected $sandBoxEndpoint = 'https://sandbox.99bill.com/mobilegateway/recvMerchantInfoAction.htm';
	...
	{
		return $this->response = new WapPurchaseResponse($this, $data);
	}
